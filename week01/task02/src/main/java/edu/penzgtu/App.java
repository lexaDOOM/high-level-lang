...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println();
        // For int (32 bits) range is: from -(2^31) = -2147483648 to 2^31 - 1 =
        // 2147483647
        ...
        System.out.println();
        // For long (64 bits) range is: from -(2^63) = -9223372036854775808 to 2^63 - 1
        // = 9223372036854775807
        ...
        // double has 18446744073709551616 different values (2^64 =
